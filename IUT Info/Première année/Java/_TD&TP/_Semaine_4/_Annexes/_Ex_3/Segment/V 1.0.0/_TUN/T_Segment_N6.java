...
public class T_Segment_N6
{
   public static void main (String[] args)
   	{
      Tests.Begin("Geom2D.Segment", "1.0.0");

         Tests.Design("Controle de la methode symetrie centrale", 3);
         {
            Tests.Case("Methode symetrie");
            {
            	...
            	Point p5= new Point (-1, 2.25);
 				...
 				try
 				{
     				...
     				Tests.Unit("[ (-0.0 , -0.0),(1.0 , 2.0) ]",  s.symetrie().toString());
   				}
   				catch (Throwable e)
   				{
 				...
 				try
 				{
     				...
     				Tests.Unit("[ (-1.0 , -1.0),(-1.0 , -4.5) ]",  s.symetrie().toString());
   				}
   				catch (Throwable e)
   				{
   					System.out.println(e.getMessage());
 				...
 				try
 				{
     				...
     				Tests.Unit("[ (-1.5 , 2.0),(1.0 , -2.25) ]",  s.symetrie().toString());
   				}
   				catch (Throwable e)
   				{
   					System.out.println(e.getMessage());
