...
*    + Version 2.0.0	: La classe devient abstraite
*    + Version 3.0.0	: Utilisation des services de la classe Temps
*
*
...
**/
	public Animal(String nom, String race, Character sexe, int jour, int mois, int annee) throws Throwable
	{
		...
		if (!Temps.verifierDate(jour, mois, annee)) throw new Throwable ("-4");
		if (annee > Calendar.getInstance().get(Calendar.YEAR)) throw new Throwable ("-5");
		// traitement
...
**/
	public String toString()
	{
		return getClass().getName() + " " + nom + ", " + race + ", " + sexe + ", "
			+ Temps.toStringDate(dateNaissance[0], dateNaissance[1], dateNaissance[2]);
	}
...
**/
	public boolean equals(Object o)
	{
		...
		if (!Temps.equals(dateNaissance[0], dateNaissance[1], dateNaissance[2], c.dateNaissance[0], c.dateNaissance[1], c.dateNaissance[2])) return false;
		return true;
	}
